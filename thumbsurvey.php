...
<body>
    ...
    <?php
          ...
          if(isset($_SESSION['thumb'])){
            if($_SESSION['thumb']==-1){
              ...
              echo $_SESSION['thumb']-time();
          }else{
            $_SESSION['thumb'] = time()+10*60;
            echo $_SESSION['thumb']-time();
          }
    ?>
  </div>
  <div id="wrapper">
    <div id="addCommentContainer">
      <h2 class="task-title">“Extra Thumb” Working Area</h2>

      <hr/>
      <div >
        <h3><span class="countdown"></span></h3>
        What practical benefits or difficulties will arise when 
        people start having this extra eye? <br/><br/>
        <?php
        if($_GET['r']==0){
          echo "Please focus on the how will the SOCIETY benefit when people have this extra thumb.";
        }else if($_GET['r']==1){
          echo "Please focus on the how will individuals benefit when people have this extra thumb.";
        }
       
        ?>
        <br/>
        <div class="conlumn"><img src="img/thumb_picture.png"></div>
        <div class="conlumn ideaCon">
          <div class="ideas style8">
...
<div class="footer">
    ...
    <?php
      if(!isset($_SESSION['thumbfinished'])){
        $_SESSION['thumbfinished'] = 1;
        $_SESSION['thumbt'] = time() - $_SESSION['thumbt']; 
      }
      echo "<br/>You spent ".$_SESSION['thumbt']."s on thumb.php.";
    ?>
</div>  
</body>
</html>
